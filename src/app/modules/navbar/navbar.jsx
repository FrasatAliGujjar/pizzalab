...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-red-800 border-gray-200 navbar-body">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div
            className={`absolute top-16 left-0 w-full bg-red-800 md:static md:w-auto md:block md:bg-transparent transition-all duration-300 ease-in-out transform ${isMenuOpen ? "opacity-100 scale-100 visible" : "opacity-0 scale-95 invisible"
              } md:opacity-100 md:scale-100 md:visible`}
          >
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-red-800 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent">
              <li>
                <Link
                  href="/"
